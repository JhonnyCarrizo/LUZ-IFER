...
function enviar(){
    ...
    let condicion = document.querySelector('input[name="arrCondicion"]:checked');
    ...
    if(erTools.test(tools) == false){
        alert('Nombre no valido, por favor, ingrese el nombre de la herramienta.')
        return false;
    }
    ...
    if(erEstado === ""){
        alert('Escriba una descripcion del estado en el que se encuentra la herramienta que quiera guardar.');
        return false;
    }
